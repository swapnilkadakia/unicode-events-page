        ...
        <Paper style={myStyle.paper}>
          <div style={this.styles.container}>
            ...
            <div className="openSans-18-400" style={this.styles.subText}>
              ...
              dicta non esse porro corrupti facilis nisi magnam perspiciatis
              eius quia enim ullam, accusantium reiciendis quibusdam laudantium
              ipsum exercitationem? Temporibus veniam fugit, dicta architecto
              quod fugiat voluptas sit. Excepturi, libero et? Lorem ipsum dolor
              sit amet consectetur adipisicing elit. Quod, placeat. Tempore sunt
              qui id ipsum laborum! Perferendis reprehenderit impedit tempora!
            </div>
            ...
            <div className="openSans-26-600" style={this.styles.btnDesign}>
              <div style={this.styles.buyBtnContainer}>
                ...
                />
                <div style={this.styles.price}>{this.props.price}</div>
              </div>
            </div>
